...
public class NeedLogInTest {
    ...
    public void needLogIn() throws NoSuchMethodException {
        boolean isLoggin1= LoggedInProcessor.needLogIn(new NeedLogInTest(),"test1",String.class);
        Assert.assertTrue(isLoggin1);
        boolean isLoggin2= LoggedInProcessor.needLogIn(new NeedLogInTest(),"test2",String.class);
        Assert.assertFalse(isLoggin2);
    }
    @LoggedIn
