...
//	public static final String X_GOMEPLUS_PUBPLAT = "x-gomeplus-pubplat";
	public static final String X_GOMEPLUS_SID = "x-gomeplus-sid";
	public static final String X_GOMEPLUS_SECRETKEY = "x-gomeplus-secretkey";
	//query公共参数
	...
	public static final String QUERY_PARAM_SECRETKEY = "secretKey";
	public static final String QUERY_PARAM_IP = "ip";
//	public static final String QUERY_PARAM_PUBPLAT = "pubPlat";
	...
	public static final String intraProDomain= "api.bs.pro.gomeplus.com";
	public static final String publicProDomain= "api-bs.gomeplus.com";
}
