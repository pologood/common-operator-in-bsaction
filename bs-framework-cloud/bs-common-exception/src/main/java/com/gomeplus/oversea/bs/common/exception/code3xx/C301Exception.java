package com.gomeplus.oversea.bs.common.exception.code3xx;


import com.gomeplus.oversea.bs.common.exception.RESTfull3xxBaseException;
...
public class C301Exception extends RESTfull3xxBaseException implements Serializable {
    ...
    public C301Exception(String message,Error error){
