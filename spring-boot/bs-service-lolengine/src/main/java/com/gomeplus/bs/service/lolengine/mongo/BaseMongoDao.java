 ...
 * @Description TODO
 * @author mojianli
 * @date 2016年12月15日 下午3:58:59
 */
package com.gomeplus.bs.service.lolengine.mongo;
...
public interface BaseMongoDao<T> {
   ...
   /**
    * @Description 根据集合名称获取自增主键id 
    * @author mojianli
    * @date 2016年12月15日 下午5:04:58
