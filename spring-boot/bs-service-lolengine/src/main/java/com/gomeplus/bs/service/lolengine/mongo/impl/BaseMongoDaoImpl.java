package com.gomeplus.bs.service.lolengine.mongo.impl;
...
import com.gomeplus.bs.service.lolengine.util.ReflectUtil;
import com.mongodb.WriteResult;

/**
 * @Description Mongo 底层实现类
 * @author mojianli
 * @date 2016年12月15日 下午4:12:22
 * @param <T>
 */
public abstract class BaseMongoDaoImpl<T> implements BaseMongoDao<T> {
    ...
    // pageBean.setRecordList(this.findAll(query.skip((pageNumber - 1) *
